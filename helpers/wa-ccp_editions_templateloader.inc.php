...
function plugin_get_template_part($slug, $name = null) {
  ...
  plugin_get_template_path($templates, true, false);
}
...
function plugin_get_template_path($template_names, $load = false, $require_once = true ) {
    $located = ''; 
